...
- (void)setModel:(MzzCard_NumModel *)model{
    _model = model;
    ...
    [_chufangjine setText:[@"处方金额：" stringByAppendingString:[NSString stringWithFormat:@"%ld元",model.pres_money]]];
    [_dongjiejine setText:[@"冻结金额：" stringByAppendingString:[NSString stringWithFormat:@"%ld元",model.dj_amount]]];
    [_shangpinjine setText:[NSString stringWithFormat:@"商品金额：%@元",model.amount_a]];
    [_yue setText: [NSString stringWithFormat:@"余额：%ld元",model.amount_yue]];
    [_shengyudongjie setText:[NSString stringWithFormat:@"剩余/冻结：%ld次/%ld次",_model.num,_model.sales_num]];
