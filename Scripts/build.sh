...
# 上传到蒲公英
res=$(curl -F "file=@${out_path}/$project_name.ipa" -F "uKey=59a077131a0183ce230ebbb5dfa8acaa" -F "_api_key=de365d7431b3e7de7926b16ce5063c84" https://upload.pgyer.com/apiv1/app/upload)
# 删除返回数据的空格。否则jq 无法解析
