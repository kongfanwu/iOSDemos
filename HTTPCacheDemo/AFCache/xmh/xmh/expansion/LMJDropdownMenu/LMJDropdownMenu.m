...
- (void)createMainBtnWithFrame:(CGRect)frame{
    ...
    _mainBtn.layer.borderColor  = kLabelText_Commen_Color_6.CGColor;
...
- (void)setMenuTitles:(NSArray *)titlesArr rowHeight:(CGFloat)rowHeight{
    ...
    // 下拉列表TableView VIEW_HEIGHT(_listView))
...
- (void)showDropDown{   // 显示下拉列表
    ...
    [UIView animateWithDuration:AnimateTime animations:^{
        ...
        _listView.frame  = CGRectMake(VIEW_X(_listView), VIEW_Y(_listView), VIEW_WIDTH(_listView),_rowHeight *count );//_rowHeight *_titleArr.count
