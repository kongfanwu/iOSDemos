...
@implementation LApproveCellType9
...
- (void)setModel:(LApproveDetailModel *)model
{
    ...
    _lb1.text = [NSString stringWithFormat:@"%@的升卡续卡审批",model.data.initiator];
    ...
    _lb6.text = [NSString stringWithFormat:@"订单金额: %ld",model.data.price];
    _lb7.text = [NSString stringWithFormat:@"应付金额: %ld",model.data.price_s];
