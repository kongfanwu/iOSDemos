...
#import "XMHXLFormButtonCell.h"

@implementation XMHXLFormButtonCell

// 在主表单中注册对应的cell以及对应的ID
+(void)load
{
    [XLFormViewController.cellClassesForRowDescriptorTypes setObject:[XMHXLFormButtonCell class] forKey:XLFormRowDescriptorTypeXMHXLFormButtonCell];
}
...
-(void)update
{
    ...
    if (self.rowDescriptor.valueTransformer) {
        ...
        self.detailTextLabel.text = [valueTransformer transformedValue:self.rowDescriptor.value];
    } else {
        self.detailTextLabel.text = self.rowDescriptor.value;
    }
}
