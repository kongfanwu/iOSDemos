...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    XMHReportFilterCell *cell = [XMHReportFilterCell cellWithTableView:tableView andTreeItem:item];
    ...
    cell.checkButtonClickBlock = ^(MYTreeItem *item) {
        ...
        /** 全选  反选  按钮  状态更新 */
//        if ([wself.delegate respondsToSelector:@selector(tableViewController:checkItems:)]) {
//            [wself.delegate tableViewController:wself checkItems:wself.manager.allCheckItem];
//        }
...
- (void)tableView:(UITableView *)tableView didSelectItems:(NSArray <MYTreeItem *>*)items isExpand:(BOOL)isExpand {
    ...
    for (NSIndexPath *indexPath in updateIndexPaths) {
        XMHReportFilterCell *cell = [tableView cellForRowAtIndexPath:indexPath];
        [cell updateItem];
    }
}
