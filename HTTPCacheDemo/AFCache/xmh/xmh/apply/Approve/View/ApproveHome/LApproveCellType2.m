...
@implementation LApproveCellType2
...
- (void)setModel:(LApproveDetailModel *)model
{
    ...
    _lb1.text = [NSString stringWithFormat:@"%@的会员冻结审批",model.data.initiator];
    ...
    _lb5.text = [NSString stringWithFormat:@"冻结原因: %@",model.data.cause];
