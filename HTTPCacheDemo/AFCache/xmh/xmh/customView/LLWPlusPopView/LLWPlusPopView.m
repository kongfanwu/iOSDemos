...
- (void)setupMainView {
    ...
    pageControl.currentPageIndicatorTintColor = HexColorInt32_t(f10180);
    [pageControl setValue:[UIImage imageNamed:@"group"] forKeyPath:@"pageImage"];
    [pageControl setValue:[UIImage imageNamed:@"group_select"] forKeyPath:@"currentPageImage"];
...
- (void)setupBottom {
    ...
    shutImgView.image = [UIImage imageNamed:@"chahao"];
    ...
    [UIView animateWithDuration:kAnimationDuration animations:^{
        self.shutImgView.transform = CGAffineTransformMakeRotation(M_PI_2);
    }];
}
