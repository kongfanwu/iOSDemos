...
@interface XMHBlockTrampoline ()
@property (nonatomic, readonly, copy) id block;
@end

@implementation XMHBlockTrampoline
...
+ (id)invokeBlock:(id)block withArguments:(NSArray *)arguments {
    ...
    XMHBlockTrampoline *trampoline = [(XMHBlockTrampoline *)[self alloc] initWithBlock:block];
