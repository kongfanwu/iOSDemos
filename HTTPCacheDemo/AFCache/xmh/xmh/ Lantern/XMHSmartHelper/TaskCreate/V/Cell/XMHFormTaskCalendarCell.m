...
#import "XMHFormTaskCalendarCell.h"
#import "NSDate-Helper.h"
#import "XMHFormRowDescriptor.h"

@implementation XMHFormTaskCalendarCell


// 在主表单中注册对应的cell以及对应的ID
+(void)load
{
    [XLFormViewController.cellClassesForRowDescriptorTypes setObject:[XMHFormTaskCalendarCell class] forKey:XLFormRowDescriptorTypeXMHFormTaskCalendarCell];
}
